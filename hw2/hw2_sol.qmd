...
There are hours smaller than 0. Also, we could find that about the period of parents' admission is 4 hours.
...
There are numbers that smaller than 0 and larger than 60. Also, patients come every 10 minutes.
...
```{r}
labevents_tble<-as_tibble(read_csv(str_c(mimic_path,"/hosp/labevents.csv.gz"),col_select = )) 
#%>%
#filter(item==50912|item_id==50971|item_id==50983|item_id==50902|item_id==50882|item_id==51221|item_id==51301|item_id==50931) 
```
